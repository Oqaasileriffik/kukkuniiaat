...
<a class="link-primary mx-3" href="./terms"><i class="bi bi-exclamation-diamond"></i> {l10n:LBL_TERMS}</a>
<a class="link-primary mx-3" href="./terms#privacy"><i class="bi bi-shield-lock"></i> {l10n:LBL_PRIVACY}</a>
<a class="link-primary mx-3" href="./help"><i class="bi bi-question-square"></i> {l10n:LBL_SUPPORT}</a>
</div>
